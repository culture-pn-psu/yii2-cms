...
class MenuSearch extends Menu
{
    ...
    {
        return [
            [['id', 'root', 'lft', 'rgt', 'level', 'status', 'created_by', 'created_at', 'updated_by', 'updated_at'], 'integer'],
            [['name', 'title', 'slug', 'image', 'meta_title', 'meta_keywords', 'meta_description', 'deleted_at'], 'safe'],
        ];
    }
