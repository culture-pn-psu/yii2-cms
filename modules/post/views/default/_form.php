...
?>
    <div class="row" style="margin-bottom: 15px;">
        <div class="col-xs-12">
            <div class="btn-group">
                <a class="btn btn-primary btn-flat" href="<?= Url::to(['index']); ?>"><i class="fa fa-table"></i> <?= ucfirst($this->context->module->id) ?></a>
                <a class="btn btn-default btn-flat" href="/web-admin/category"><i class="glyphicon glyphicon-list-alt"></i> หมวดหมู่</a>
                <a class="btn btn-warning btn-flat" href="<?= Url::to(['trash/index']) ?>"><i class="glyphicon glyphicon-trash"></i> ถังขยะ</a>
                <a class="btn btn-github btn-flat" href="<?= Url::to(['setting/index']) ?>"><i class="glyphicon glyphicon-cog"></i> ตั้งค่า</a>
            </div>
        </div>
    </div>
<div class="post-form">
